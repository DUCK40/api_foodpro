...
router.route('/').post(upload.single('IMG'),(req,res)=>{
    ...
    // const data = req.body
    var obj =require('../../controller/shop/uploadpicshopitem')
    obj.func_post(req.file.filename,req.body.SHOP_CODE,req.body.CATE_CODE,req.body.SUB_CATE_CODE,req.body.TYPE_CATE_CODE,req.body.ADMIN_NAME,res)
