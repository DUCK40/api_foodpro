...
//Section CURD
exports.func_post = function(path, shopcode, adminname, res) {
  const ip = globalIP;
  insertPicProfile(path, shopcode, adminname, res, ip);
};
...
async function insertPicProfile(path, SHOP_CODE, ADMIN_NAME, res, ip) {
  try {
    ...
    var ACTION_DESC = "UPDATE PIC SHOP PROFILE";
